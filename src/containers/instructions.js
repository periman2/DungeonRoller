    ...
    render(){
        ...
        if(this.state.show){
            ...
            <div className='details' >
                ...
                <ul>
                    <li><p>Use the arrow keys to navigate. The ball has a velocity and an acceleration. Each time you change element this changes too so be careful not to slip.</p></li>
